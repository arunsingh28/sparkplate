...
const collapse: React.FC<CollapseItem> = () => {
    const items: CollapseProps['items'] = [
        {
            key: '1',
            label: <p className='text-[15px] font-semibold text-gray-800'>Sererity</p>,
            ...
            classNames: {
                ...
                header: 'bg-[#f5f5f5] !border-none',
            },
        },
        {
            key: '2',
            label: <p className='text-[15px] font-semibold text-gray-800'>Show</p>,
            children: <div className="flex flex-col gap-2 items-start">
            {
        ...
        {
            key: '3',
            label: <p className='text-[15px] font-semibold text-gray-800'>Scan type</p>,
            children: <div className="flex flex-col gap-2 items-start">
            {
        ...
        {
            key: '4',
            label: <p className='text-[15px] font-semibold text-gray-800'>Language</p>,
            children: <div className="flex flex-col gap-2 items-start">
            {
